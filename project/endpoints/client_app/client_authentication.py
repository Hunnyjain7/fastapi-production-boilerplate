...
#         else:
#             return Utility.commonResponse(status=FAIL, message="Invalid credential's", error=[], data={})
#         if verify_password is True:
#             login_token = AuthHandler().encode_token(str(user_id))
#         else:
#             return Utility.commonResponse(status=FAIL, message="Invalid credential's", error=[], data={})
#         if login_token:
#             token_update = user.update({UsrUser.token: login_token}, synchronize_session=False)
#             db.flush()
#             db.commit()
#             if token_update == 1:
#                 response = {
...
#                     "association_id": user[0].association_id,
#                     "association_type_term": user[0].association_type_term,
#                     "user_name": user[0].user_name,
#                     "status_term": user[0].status_term,
#                     "profile_pic": user[0].profile_pic,
#                     "display_name": user[0].display_name,
#                     "created_on": str(user[0].created_on),
#                     "created_by": user[0].created_by,
#                     "updated_on": str(user[0].updated_on),
#                     "updated_by": user[0].updated_by,
#                     "email": user[0].email,
#                     "mobile_no": user[0].mobile_no,
#                     "is_active": user[0].is_active,
#                     "update_log": str(user[0].update_log),
#                     "user_type_term": user[0].user_type_term,
#                     "is_default": user[0].is_default,
#                     "is_it_admin": user[0].is_it_admin,
#                 }
#                 return Utility.commonResponse(status=SUCCESS, message="Admin logged In", error=[],
#                                               data=response)
#         else:
#             return Utility.commonResponse(status=FAIL, message="Token not assigned", error=[], data={})
#     except Exception as E:
#         print(E)
#         return Utility.commonResponse(status=FAIL, message="Something went wrong", error=[], data={})
#
#
...
#         else:
#             return Utility.commonResponse(status=FAIL, message="Invalid email", error=[], data={})
...
#                 return Utility.commonResponse(status=SUCCESS, message="Email sent for reset password", error=[],
#                                               data={})
#             return Utility.commonResponse(status=FAIL, message="Error while sending email", error=[], data={})
#     except Exception as E:
#         print(E)
#         return Utility.commonResponse(status=FAIL, message="Something went wrong", error=[], data={})
#
...
#             db.commit()
#         else:
#             return Utility.commonResponse(status=FAIL, message="Invalid token", error=[], data={})
#         if password_update == 1:
#             return Utility.commonResponse(status=SUCCESS, message="Password updated", error=[],
#                                           data={})
#         return Utility.commonResponse(status=FAIL, message="Fail to update new password", error=[], data={})
#     except Exception as E:
#         print(E)
#         return Utility.commonResponse(status=FAIL, message="Something went wrong", error=[], data={})
#
...
#         if len(user.all()) != 1:
#             return Utility.commonResponse(status=FAIL, message="Invalid detail's", error=[], data={})
...
#             db.flush()
#             db.commit()
#             return Utility.commonResponse(status=SUCCESS, message="Password changed", error=[], data={})
#         return Utility.commonResponse(status=FAIL, message="Invalid password", error=[], data={})
#     except Exception as E:
#         print(E)
#         return Utility.commonResponse(status=FAIL, message="Something went wrong", error=[], data={})
#
...
#         # if len(smtp.all()) != 1:
#         #     return Utility.commonResponse(status=FAIL, message="Invalid smtp", error=[], data={})
#         # response_data = {
...
#             return Utility.commonResponse(status=FAIL, message="Provide valid detail's", error=[], data={})
...
#             return Utility.commonResponse(status=FAIL, message="Provide valid tls", error=[], data={})
#         if int(is_ssl) != 0 and int(is_ssl) != 1:
#             return Utility.commonResponse(status=FAIL, message="Provide valid ssl", error=[], data={})
#         if type(port_no) != int:
#             return Utility.commonResponse(status=FAIL, message="Port number must be integer", error=[], data={})
#
...
#             db.commit()
#             if new_smtp.seq_no:
#                 return Utility.commonResponse(status=SUCCESS, message="Web setting's data updated", error=[], data={})
#             return Utility.commonResponse(status=FAIL, message="Update failed", error=[], data={})
#     except Exception as E:
#         print(E)
#         return Utility.commonResponse(status=FAIL, message="Something went wrong", error=[], data={})
#
...
#         response_data = {}
#         pass
#         return Utility.commonResponse(status=SUCCESS, message="Web setting's data fetched", error=[],
#                                       data=response_data)
#     except Exception as E:
#         print(E)
#         return Utility.commonResponse(status=FAIL, message="Something went wrong", error=[], data={})
